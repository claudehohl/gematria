...
|--------------------------------------------------------------------------
|
| Enables adding and updating entries.
|
*/
$config['password'] = '';
...
$config['sess_cookie_name'] = 'gematria';
...
$config['db_username'] = 'gematria';
$config['db_password'] = 'gematria';
$config['db_database'] = 'db/gematria';
